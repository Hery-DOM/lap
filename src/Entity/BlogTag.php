...
class BlogTag
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\BlogArticle", mappedBy="blog_tag")
     */
    ...
    public function removeBlogArticle(BlogArticle $blogArticle): self
    {
        if ($this->blogArticles->contains($blogArticle)) {
            ...
            if ($blogArticle->getBlogTag() === $this) {
                $blogArticle->setBlogTag(null);
            }
        }
